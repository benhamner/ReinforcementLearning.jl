...
iterations=10
base_players = Vector{Function}[[], [random_player], [random_player]]
base_player_names = ["Self", "Rand", "Rand+Self"]
play_self = [true, false, true]
...
for i=1:iterations
    ...
    for j=1:length(train_functions)
        ...
        win_percentage, draw_percentage, loss_percentage, results_txt = evaluate_connect_four_players(q_player, make_lookahead_player(1), 1_000)
