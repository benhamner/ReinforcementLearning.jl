...
for sample=1:10
    for learning_rate = [0.01,0.1,0.5,1.0,5.0,10.0,50.0,100.0,200.0,500.0,1000.0,2000,5000,10_000,20_000]
        ...
        win_percentage, draw_percentage, loss_percentage, results_txt = evaluate_tic_tac_toe_players(q_net_player, random_player, 1000)
